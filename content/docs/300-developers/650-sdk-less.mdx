...
![Parsed Memo](/images/sdk-less/SDKless-03-parse_memo.png)

We can also use the Laboratory to create correctly formatted memos in the first place.

![Generated Memo](/images/sdk-less/SDKless-04-create_memo.png)
...
![KIN Transaction](/images/sdk-less/SDKless-06-transaction_dev_portal.png)
...
<div className="mt-8 grid gap-6 md:grid-cols-2">
  ...
  />
  <NavCard
    title="Kin DApp Playground"
    subtitle="A multi-functional Kin Front-End that allows you to connect to a Kin Server or carry out Web-based transactions via our Web-SDK or SDK-less."
    icon="github"
    link={{ url: 'https://github.com/kin-starters/kin-dapp-playground', label: 'Have a look' }}
  />
</div>
